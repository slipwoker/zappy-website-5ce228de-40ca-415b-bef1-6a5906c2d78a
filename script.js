...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const navbar = document.querySelector('.navbar, header, [class*="nav"]');
    if (navbar) {
    ...
    if (contactForm) {
        ...
        function clearAllErrors() {
            contactForm.querySelectorAll('.' + errorClass).forEach(input => {
                clearError(input);
            });
        }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .then(data => {
                    ...
                    successMessage.style.cssText = 'color: #27ae60; padding: 1rem; margin-top: 1rem; text-align: center;';
                ...
                .catch(error => {
                    ...
                    errorMessage.style.cssText = 'color: #e74c3c; padding: 1rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5ce228de-40ca-415b-bef1-6a5906c2d78a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5ce228de-40ca-415b-bef1-6a5906c2d78a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5ce228de-40ca-415b-bef1-6a5906c2d78a';
